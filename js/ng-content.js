...
app.controller('MainController', ['$scope', function ($scope) { 
    ...
    $scope.aboutme2 = "These days I'm excited to learn all I can about web design and development. I started experimenting with web design while coordinating content for my company's mobile redesign.  I was surprised by how much I enjoyed working on the project!  I took a few online courses and then was lucky to discover the Code Louisville program - a 12 week coding bootcamp offered through Kentuckiana Works.  I completed the Front-End dev cohort in March, and now I'm working on the Code Louisville PHP course and UX Research and Strategy class from DesignLab. In my spare time I'm studying Angular.js, Wordpress and Drupal, as well as continually working to improve my CSS and Adobe Suite skills through multiple resdesigns of this site. One of my next projects is a site for the Performing Arts Collaborative, a group of local theatre technicians, administrators and designers who are driven to educate and involve area students in local arts opportunities. I'm thrilled that they asked me to build their site, and I hope to continue my path into software development while maintaining my ties to Louisville's arts community."; 
